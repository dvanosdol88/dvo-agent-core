...
import { MEMORY_RETRIEVAL_TOOL_CONTRACTS, buildMemorySaveReceipt, getMemoryRetrievalToolContract, } from "./index.js";
test("memory retrieval contracts expose the Phase 2 tool names in canonical order", () => {
    assert.deepEqual(MEMORY_RETRIEVAL_TOOL_CONTRACTS.map((contract) => contract.name), [
