...
export const LIST_WORKSPACE_FILES_TOOL_CONTRACT = {
    name: "list_workspace_files",
    description: "List recent files or folder contents from the connected workspace provider. Returns bounded file references and links.",
    inputSchema: {
        type: "object",
        properties: {
...
export const SEARCH_WORKSPACE_FILES_TOOL_CONTRACT = {
    name: "search_workspace_files",
    description: "Search connected workspace files by name or indexed text. Returns bounded file references and snippets when available.",
    inputSchema: {
        type: "object",
        properties: {
            query: {
...
export const READ_WORKSPACE_FILE_TEXT_TOOL_CONTRACT = {
    name: "read_workspace_file_text",
    description: "Read bounded text from a workspace file when the provider can safely export or download text.",
    inputSchema: {
        type: "object",
        properties: {
...
export const CREATE_WORKSPACE_DOCUMENT_TOOL_CONTRACT = {
    name: "create_workspace_document",
    description: "Create a provider-native document in the connected workspace and optionally seed it with text.",
    inputSchema: {
        type: "object",
        properties: {
...
export const APPEND_WORKSPACE_DOCUMENT_TOOL_CONTRACT = {
...
export const CREATE_WORKSPACE_FOLDER_TOOL_CONTRACT = {
...
export const RENAME_WORKSPACE_FILE_TOOL_CONTRACT = {
...
export const MOVE_WORKSPACE_FILE_TOOL_CONTRACT = {
...
export const COPY_WORKSPACE_FILE_TOOL_CONTRACT = {
...
export const WORKSPACE_TOOL_CONTRACTS = [
...
export function getWorkspaceToolContract(name) {
