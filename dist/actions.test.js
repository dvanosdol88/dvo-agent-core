...
import { ACTION_RECEIPT_TOOL_CONTRACTS, buildActionReceipt, buildSurfaceSyncProposal, getActionReceiptToolContract, } from "./index.js";
test("action receipt contracts expose receipt recording and sync proposal names", () => {
    assert.deepEqual(ACTION_RECEIPT_TOOL_CONTRACTS.map((contract) => contract.name), ["record_action_receipt", "propose_surface_sync"]);
});
