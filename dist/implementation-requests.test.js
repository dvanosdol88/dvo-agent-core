...
import { IMPLEMENTATION_REQUEST_TOOL_CONTRACTS, buildImplementationHandoffMarkdown, buildImplementationRequest, buildImplementationResult, getImplementationRequestToolContract, } from "./index.js";
test("implementation request contracts expose bounded lifecycle tools", () => {
    assert.deepEqual(IMPLEMENTATION_REQUEST_TOOL_CONTRACTS.map((contract) => contract.name), [
