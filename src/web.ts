...
export const SEARCH_WEB_TOOL_CONTRACT: ToolContract = {
  name: "search_web",
  description:
    "Search the public web for current information and return cited source references.",
  inputSchema: {
    type: "object",
    properties: {
...
export const READ_WEB_URL_TOOL_CONTRACT: ToolContract = {
  name: "read_web_url",
  description:
    "Read bounded text from a specific public web URL for source-grounded research.",
  inputSchema: {
    type: "object",
    properties: {
...
export const LIST_WEB_PAGE_LINKS_TOOL_CONTRACT: ToolContract = {
  name: "list_web_page_links",
  description:
    "Map a public web page or site area and return bounded links for follow-up reading.",
  inputSchema: {
    type: "object",
    properties: {
...
export const CRAWL_WEB_SITE_TOOL_CONTRACT: ToolContract = {
  name: "crawl_web_site",
  description:
    "Crawl a bounded public site area and return extracted source text from relevant pages.",
  inputSchema: {
    type: "object",
    properties: {
...
export const PUBLIC_WEB_TOOL_CONTRACTS: ToolContract[] = [
...
export function getPublicWebToolContract(
  name: string,
